...
def parse_args():
    ...
    parser.add_argument(
        "--det_model_name",
        default="YOLOModel",
        help="Name of the object detection model to use (default: YOLOModel).",
    )
    parser.add_argument(
        "--det_model_ckpt",
...
def run(
    ...
    det_model = detection_model.load(det_model_name, det_model_ckpt, det_model_conf)
