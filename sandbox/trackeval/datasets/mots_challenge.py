...
class MOTSChallenge(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': os.path.join(code_path, '../data/trackeval/gt/mot_challenge/'),  # Location of GT data
            # /home/guest/dev_repo/SoccerTrack/data/trackeval/gt/mot_challenge
            'TRACKERS_FOLDER': os.path.join(code_path, '../data/trackeval/trackers/mot_challenge/'),  # Trackers location
