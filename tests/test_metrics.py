...
class TestMetrics(unittest.TestCase):
    def test_iou_score(self):
        bbox_det = [10, 10, 20, 20]  # TODO: Manually create a bounding box
        bbox_gt = [10, 15, 20, 20]  # TODO: Manually create a another bounding box

        iou = iou_score(bbox_det, bbox_gt)
        ans = 0.5  # TODO: Manually calculate the answer
