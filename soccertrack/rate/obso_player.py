...
def calc_player_evaluate_match(OBSO, tracking_home, tracking_away):
    ...
    for frame in tqdm(range(len(tracking_home))):
        ...
        for player in home_player_num:
            ...
            home_obso[player].iloc[home_event_num-1] = calc_player_evaluate(home_player_pos, OBSO[frame])
        ...
        for player in away_player_num:
            ...
            away_obso[player].iloc[away_event_num-1] = calc_player_evaluate(away_player_pos, OBSO[frame])
